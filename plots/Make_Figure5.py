...
file_names = [
    'figure_os_ALL_dr_1.csv',
    'figure_os_ALL_dr_2.csv',
    'figure_os_ALL_dr_3.csv',
    'figure_os_ALL_dr_4.csv',
    'figure_os_ALL_dr_5.csv'
]
...
plt.savefig('DecModMis_5.pdf', dpi=300, bbox_inches='tight')
plt.show()
